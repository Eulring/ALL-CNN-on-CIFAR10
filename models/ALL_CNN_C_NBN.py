...
# python3 main2.py train  --use_trained_model=False --model='ALL_CNN_C_NBN' --checkpoint_save_name='ALL_CNN_C_NBN-1' --lr1=0.15 --lr2=0.1 --lr3=0.05 --lr4=0.01 --weight_decay=0.001 --use_clip=True --clip=2.0
...
class ALL_CNN_C_NBN(BasicModule):
    
    def __init__(self, num_classes = 10):
        
        super(ALL_CNN_C_NBN, self).__init__()
        
        self.model_name = 'ALL_CNN_C_NBN'
